...
export default function Header() {
  ...
  return (
    <header className="flex flex-row-reverse place-content-around after:content-[''] after:flex-1 *:flex-1 items-end bg-cyan-950 p-4 fixed w-auto min-w-screen relative">
